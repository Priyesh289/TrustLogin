...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
     ...
     font-medium mb-2'>Hello {userData?.name || 'Users'}
        <img className='w-8 aspect-squre' alt=''
          src={assets.hand_wave} />
      </h1>

      <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome To our app</h2>
      <p className='mb-8 max-w-md'>Let's start with a quick product tour we will have
