...
const ResetPassword = () => {
  ...
  return (
    ...
    from-blue-200 to-purple-400'>
      ...
      top-5 w-28 sm:w-32 ncursor-pointer'/>
      ...
      {!isEmailSent &&
        <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg w-96 text-sm'>
          ...
          <div className='mb-4 flex items-center gap-3 w-full pw-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img src={assets.mail_icon} alt='' className='w-8 h-3' />
      ...
      {!isOtpSubmitted && isEmailSent &&
        <form className='bg-slate-900 p-8 rounded-lg w-96 text-sm'>
          <h1 className='text-white text-2xl font-semibold text-center mb-4'>Reset Paasword OTP</h1>
      ...
      {isOtpSubmitted && isEmailSent &&
        <form className='bg-slate-900 p-8 rounded-lg w-96 text-sm'>
          ...
          <div className='mb-4 flex items-center gap-3 w-full pw-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img src={assets.lock_icon} alt='' className='w-8 h-3' />
